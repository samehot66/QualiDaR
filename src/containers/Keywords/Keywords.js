  ...
  useEffect(() => {
    setpublicfilterserch(
      publickeywords.filter((gkeyword) => {
        return gkeyword.groupname
          .toString()
          .toLowerCase()
          .includes(searchpublic.toLowerCase());
      })
    );
    ...
    setprivatefilterserch(
      privatekeywords.filter((gkeyword) => {
        return gkeyword.groupname
          .toString()
          .toLowerCase()
          .includes(searchprivate.toLowerCase());
      })
    );
              ...
              >
                ...
                <tbody>
                  {publicfilterserch.map((gkeyword) => (
                    <tr key={gkeyword.keywordgroupsid}>
                      <Publickeywords
                        gname={gkeyword.groupname}
                        owner={gkeyword.owner}
                        groupid={gkeyword.keywordgroupsid}
                        key={gkeyword.keywordgroupsid}
                        type="notmember"
                        onGetpubgroups={handleGetpubgroups}
                      />
                    </tr>
                  ))}
                </tbody>
          ...
          <div className={["card card-info", classes.Box].join(" ")}>
            ...
            >
              <h3 className="card-title">
                ...
                <Modal
                  show={Newgroupmodal}
                  modalClosed={closenewgroupModal}
                  name="Create new keyword group"
                >
                  <Addgroup
                    cancel={closenewgroupModal}
                    onGetyourgroups={handleGetyourgroups}
                  />
                </Modal>
              </h3>
              <div className="card-tools">
                    ...
                    {subscribekeywords.map((gkeyword) => (
                      <tr key={gkeyword.keywordgroupsid}>
                        <Publickeywords
                          ...
                          key={gkeyword.keywordgroupsid}
                          type="member"
                          onGetsubgroups={handleGetsubgroups}
                        />
                      </tr>
                    ))}
                  </tbody>
